...
import com.listener.JobCompletionNotificationListener;
import com.listener.StepResultListener;
import com.processor.TimesheetStaffItemProcessor;
import com.processor.TimesheetStaffItemProcessor2;
import com.timesheetstaff.TimesheetStaff;
...
public class BatchConfig{
    ...
    public Step step2(MongoItemReader<TimesheetStaff> reader2) {
        return stepBuilderFactory.get("step2")
                .<TimesheetStaff, TimesheetStaff> chunk(10)
                .reader(reader2)
                .processor(new TimesheetStaffItemProcessor2())
                .writer(writer2(null))
                .allowStartIfComplete(true)
                .listener(new StepResultListener())
                .build();
